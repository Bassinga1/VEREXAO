...
class UserUpdateEventListener
{
    ...
    public function preUpdate(User $user):void{
        ...
        $user->setSecretIv(base64_encode($iv)); // On encode en base64 pour pouvoir le stocker en BDD parce que la clé contient des caractères speciaux instockables dans une BDD
